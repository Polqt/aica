...
const steps = [
  ...
  },
  {
    ...
    accent: 'bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 border-indigo-200 dark:border-indigo-800/30',
  },
  {
    path: '/experience',
    ...
    <OnboardingProvider>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/10 to-purple-50/5 dark:from-slate-900 dark:via-blue-900/5 dark:to-purple-900/3 relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute left-1/4 top-1/4 h-150 w-150 rounded-full bg-gradient-to-br from-blue-300/45 to-purple-300/40 dark:from-blue-700/35 dark:to-purple-700/30 blur-3xl animate-pulse-slow"></div>
          ...
          <div className="absolute bottom-1/4 left-1/3 h-140 w-140 rounded-full bg-gradient-to-br from-purple-300/44 to-violet-300/38 dark:from-purple-700/34 dark:to-violet-700/30 blur-3xl animate-pulse-slow delay-2000"></div>
          
          {/* Additional large gradient elements - maximum visibility */}
          <div className="absolute top-20 right-20 h-110 w-110 rounded-full bg-gradient-to-br from-blue-400/40 to-indigo-400/35 dark:from-blue-600/32 dark:to-indigo-600/28 blur-3xl"></div>
          ...
          <div className="absolute bottom-1/6 right-1/6 h-115 w-115 rounded-full bg-gradient-to-br from-blue-200/40 to-violet-200/36 dark:from-blue-800/32 dark:to-violet-800/28 blur-3xl"></div>
          ...
          <div className="absolute top-1/5 right-1/5 h-90 w-90 rounded-full bg-gradient-to-br from-purple-300/36 to-indigo-300/32 dark:from-purple-700/28 dark:to-indigo-700/24 blur-3xl"></div>
          <div className="absolute bottom-1/5 left-1/5 h-85 w-85 rounded-full bg-gradient-to-br from-blue-300/38 to-purple-300/34 dark:from-blue-700/30 dark:to-purple-700/26 blur-3xl"></div>
          
          {/* Enhanced gradient mesh overlay */}
          <div className="absolute inset-0 bg-gradient-to-br from-blue-100/20 via-indigo-100/18 to-purple-100/15 dark:from-blue-900/15 dark:via-indigo-900/12 dark:to-purple-900/10"></div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl py-8 px-4 relative">
          ...
          <div className="text-center mb-16 transition-all duration-500 ease-out">
            {/* Enhanced Badge with Animation and Clickable Guide */}
            <Popover>
              <div className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-50 via-purple-50 to-indigo-50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-indigo-900/20 rounded-2xl mb-10 border border-blue-200/60 dark:border-blue-800/40 shadow-lg backdrop-blur-sm transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                <div className="relative">
                  <div className="w-4 h-4 bg-gradient-to-r from-blue-500 via-purple-600 to-indigo-600 rounded-full animate-pulse" />
                ...
                <PopoverTrigger asChild>
                  <span className="text-sm font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 dark:from-blue-300 dark:via-purple-300 dark:to-indigo-300 bg-clip-text text-transparent cursor-pointer hover:underline">
                    🚀 PROFESSIONAL JOURNEY
                  </span>
                </PopoverTrigger>
              </div>
              
              <PopoverContent className="w-80 p-6 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-xl">
                <div className="space-y-4">
                  <h3 className="text-lg font-bold text-slate-800 dark:text-white">
                    🚀 AICA Onboarding Guide
                  </h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-slate-700 dark:text-slate-200">
                        <strong>Create Your Profile and Build your Resume</strong>
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-sm text-slate-700 dark:text-slate-200">
                        <strong>Explore Job Matches</strong>
                      </p>
                    </div>
                    <div className="flex items-start gap-2">
                  ...
                  <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
                    <p className="text-xs text-blue-800 dark:text-blue-200">
                      ✅ <strong>Tip for Best Results:</strong> Keep your profile updated with your latest skills, trainings, and experiences so AICA can recommend the best opportunities for you.
                    </p>
                  </div>
                </div>
              </PopoverContent>
            ...
            <div className="relative mb-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-slate-700 via-slate-600 to-slate-500 dark:from-slate-200 dark:via-slate-100 dark:to-slate-50 bg-clip-text text-transparent mb-3 leading-tight tracking-normal">
                Build Your
                <br />
                <span className="bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 dark:from-blue-300 dark:via-purple-300 dark:to-indigo-300 bg-clip-text text-transparent">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    ...
                    <div className="absolute -inset-1 bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-xl blur-sm"></div>
                  </div>
                  <div>
                      ...
                      <div className="flex flex-col items-center group">
                        <div
                          className={cn(
                            ...
                            isCurrent &&
                              `bg-gradient-to-r ${step.color} shadow-2xl ring-4 ring-blue-200/60 dark:ring-blue-700/40 scale-110`,
                            isUpcoming &&
                              'bg-white/95 dark:bg-slate-700/90 border-2 border-slate-200/70 dark:border-slate-600/60 shadow-md hover:shadow-lg',
                          )}
                        >
                          {isCompleted ? (
                            <div className="relative">
                          ...
                          {isCurrent && (
                            <div className="absolute -bottom-2 -right-2 w-6 h-6 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center shadow-lg border-2 border-white dark:border-slate-800">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <Badge 
                        variant="secondary" 
                        className="bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 dark:from-blue-900/60 dark:to-indigo-900/60 dark:text-blue-200 border border-blue-200/60 dark:border-blue-600/40 px-3 py-1 text-xs font-semibold shadow-sm backdrop-blur-sm"
                      >
                        Current Step
                      </Badge>
