    ...
    <div className="relative min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex flex-col">
      ...
      <div className="flex-1 container mx-auto px-4 py-16 md:py-24">
        ...
        >
          ...
          >
            Empowering tech graduates to find their perfect career match through
        ...
        <div className="max-w-6xl mx-auto space-y-16 md:space-y-20">
          ...
          >
            <div
              className="relative mx-auto w-80 h-80 cursor-pointer group"
                      ...
                      {[
                        {
                          ...
                          description:
                            'Advanced algorithms find your perfect career matches',
                        },
                        {
                          icon: '📄',
                          title: 'Smart Resume Builder',
                          description:
                            'Create professional resumes with AI guidance',
                        },
                        {
                          icon: '📊',
                          title: 'Skill Analysis Engine',
                          description:
                            'Get detailed insights about your technical skills',
                        },
                      ].map((feature, index) => (
                        <div
                          key={index}
                          className="bg-white/60 dark:bg-slate-700/60 p-2 rounded-lg backdrop-blur-sm"
                        >
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 max-w-6xl mx-auto">
              {authors.map((author, index) => {
                ...
                const photoSrc =
                  photoMap[author.name as keyof typeof photoMap] ||
                  `/author-${index + 1}.jpg`;
                ...
                <Card className="h-full border border-blue-200 dark:border-blue-800 bg-white dark:bg-gray-900 shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden rounded-2xl">
                  ...
                  <CardContent className="space-y-4">
                    <motion.div
                      ...
                      className="relative"
                    >
                      <div className="absolute -left-4 top-0 text-6xl text-blue-200 dark:text-blue-800 font-serif">
                        &quot;
                      </div>
                      <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300 pl-6">
                        We are Nyx Arcana, a group of third-year Computer
                        Science students from the University of St. La Salle –
                        Bacolod. As part of our undergraduate thesis
                        requirement, we present to you our successfully deployed
                        project titled AICA (AI Career Assistant): A Job
                        Matching Platform Using a Large Language Model with
                    ...
                    >
                      <p className="text-gray-800 dark:text-gray-200 font-medium">
                        Our mission is to provide an innovative, intelligent,
                        and user-friendly tool that guides students and
                        graduates in building strong resumes, identifying their
                        skills, and connecting them to relevant career
                        opportunities.
                      </p>
                    </motion.div>
                ...
                <Card className="h-full border border-blue-200 dark:border-blue-800 bg-white dark:bg-gray-900 shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden rounded-2xl">
                  ...
                  <CardContent className="space-y-4">
                    <motion.div
                      ...
                      className="relative"
                    >
                      <div className="absolute -left-4 top-0 text-6xl text-purple-200 dark:text-purple-800 font-serif">
                        &quot;
                      </div>
                      <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300 pl-6">
                        To empower students and graduates with accessible,
                        AI-driven career assistance by bridging the gap between
                    ...
                    >
                      <p className="text-gray-800 dark:text-gray-200 font-medium">
                        AICA envisions a future where every graduate seamlessly
                        connects with opportunities that match their skills,
                        potential, and aspirations—helping them thrive in a
          ...
          >
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
              ...
              and turn it into a full job-finding app? Get in touch with us at:
            </p>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div>
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">
              This research paper is part of an undergraduate research paper by
              Gamboa, Hidalgo, Mahandog, Santia for University of Saint La Salle
      ...
      {/* Remove duplicated hero and authors section at the end */}
    </div>
  );
}
