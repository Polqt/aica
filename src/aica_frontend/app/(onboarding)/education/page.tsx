  ...
  async function onSubmit(values: z.infer<typeof educationFormSchema>) {
    try {
      ...
      showToastSuccess(
        ...
        `Successfully added ${values.educations.length} education record${
      ...
      showToastError('Education Update Failed', errorMessage);
    }
  }
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
                  ...
                  <li>
                    • Mention academic achievements, honors, or GPA if
                    impressive
                  </li>
                  <li>
